/**
 * @file Controller RESTful WEb service API for featured-items resource
 */
import {Request, Response, Express} from "express";
import FeaturedItemDao from "../daos/FeaturedItemDao";
import FeaturedItemControllerI from "../interfaces/FeaturedItemControllerI";
 ...
 */
export default class FeaturedItemController implements FeaturedItemControllerI {
    private static featuredItemDao: FeaturedItemDao = FeaturedItemDao.getInstance();
    private static featuredItemController: FeaturedItemController | null = null;
     ...
     */
    public static getInstance = (app: Express): FeaturedItemController => {
     ...
     */
    findAllFeaturedItems = (req: Request, res: Response) =>
        FeaturedItemController.featuredItemDao.findAllFeaturedItems()
     ...
     */
    findFeaturedItemsByRestaurant = (req: Request, res: Response) =>
        FeaturedItemController.featuredItemDao.findFeaturedItemsByRestaurant(req.params.rid)
     ...
     */
    findFeaturedItemById = (req: Request, res: Response) =>
        FeaturedItemController.featuredItemDao.findFeaturedItemById(req.params.itemId)
            .then(featuredItem => res.json(featuredItem));
     ...
     * database
     */
    createFeaturedItem = (req: Request, res: Response) =>
        FeaturedItemController.featuredItemDao.createFeaturedItem(req.params.rid, req.body)
            .then(featuredItem => res.json(featuredItem));
     ...
     */
    deleteFeaturedItem = (req: Request, res: Response) =>
        FeaturedItemController.featuredItemDao.deleteFeaturedItem(req.params.itemId)
