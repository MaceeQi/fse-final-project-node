...
const RestaurantDao_1 = __importDefault(require("../daos/RestaurantDao"));
/**
...
class RestaurantController {
    constructor() {
         ...
         */
        this.updateRestaurant = (req, res) => RestaurantController.restaurantDao.updateRestaurant(req.params.rid, req.body)
         ...
         */
        this.deleteRestaurant = (req, res) => RestaurantController.restaurantDao.deleteRestaurant(req.params.rid)
            .then(status => res.json(status));
        /**
         * Removes a restaurant instance from the database
         * @param {Request} req Represents request from client, including path
...
RestaurantController.restaurantController = null;
RestaurantController.restaurantDao = RestaurantDao_1.default.getInstance();
/**
 ...
 */
RestaurantController.getInstance = (app) => {
